<footer class="full-row bg-secondary p-0">
            <div class="container">
                                ...
                                <div class="col-md-12 col-lg-4">
                                    <div class="footer-widget mb-4">
                                        <div class="footer-logo mb-4"> <a href="#">
                                            <img class="logo-bottom" src="images/logo/logo_white2.png" height="200px" width="500px" alt="image"></a>
                                         </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-lg-4">
                                            <div class="footer-widget footer-nav mb-4">
                                                ...
                                                <ul class="hover-text-primary">
                                                    ...
                                                    <li><a href="contact.php" class="text-white">User Feedbacks</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-lg-4">
                                        ...
                                        <div class="col-md-4 col-lg-4">
                                            <div class="footer-widget">
                                                ...
                                                <ul class="text-white">
                                                    <li class="hover-text-primary"><i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>Sai Chowk,Pashan,Pune</li>
                                                    <li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+91 702 8100 208</li>
													<li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+62 823 8307 7087 385</li>
                                                    <li class="hover-text-primary"><i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>omkar.realeststepune</li>
                                                </ul>
                                            </div>
                ...
                <div class="row copyright">
                    <div class="col-sm-6"> <span class="text-white">©Copyright <?php echo date('Y');?> </span>Developed by : Giraldo Nainggolan and Omkar Phalke </div>
                    <div class="col-sm-6">
